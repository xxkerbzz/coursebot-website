  ...
  return (
    <ResourceArticle
      breadcrumbs={[
        ...
        { name: 'Best Tools for Course Content Development', url: 'https://coursebot.com/resources/online-course-creation-and-teaching/course-content-development/best-tools-for-course-content-development' },
      ]}
      title="Best Tools for Course Content Development"
