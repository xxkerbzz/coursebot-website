  ...
  return (
    <ResourceArticle
      breadcrumbs={[
        ...
        { name: 'EdTech Solutions vs Traditional Course Tools', url: 'https://coursebot.com/resources/educational-technology-and-edtech/edtech-solutions-for-creators/edtech-solutions-vs-traditional-course-tools' },
      ]}
      title="EdTech Solutions vs Traditional Course Tools"
