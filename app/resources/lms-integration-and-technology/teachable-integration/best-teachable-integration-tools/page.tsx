  ...
  return (
    <ResourceArticle
      breadcrumbs={[
        ...
        { name: 'Best Teachable Integration Tools', url: 'https://coursebot.com/resources/lms-integration-and-technology/teachable-integration/best-teachable-integration-tools' },
      ]}
      title="Best Teachable Integration Tools"
